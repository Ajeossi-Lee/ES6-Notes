/*
 * --> @Author: Ajeossi Lee
 * --> @Date: 2020-12-25 13:37:40
 * --> @Last Modified time: 2020-12-25 14:13:30
 * --> @Last Modified by: Ajeossi Lee
 * --> @Description: Summarize the use of proxy
 */

// Proxy 可以理解成在目标对象前架设一个"拦截层"
// 提供了一种机制可以对外界的访问进行改写和过滤
